...
public final class CancelSubscriptionUseCase_Factory implements Factory<CancelSubscriptionUseCase> {
  ...
  public CancelSubscriptionUseCase_Factory(Provider<BillingRepository> billingRepositoryProvider) {
  ...
  public static CancelSubscriptionUseCase_Factory create(
      Provider<BillingRepository> billingRepositoryProvider) {
    return new CancelSubscriptionUseCase_Factory(billingRepositoryProvider);
  }

  public static CancelSubscriptionUseCase newInstance(BillingRepository billingRepository) {
    return new CancelSubscriptionUseCase(billingRepository);
  }
}
