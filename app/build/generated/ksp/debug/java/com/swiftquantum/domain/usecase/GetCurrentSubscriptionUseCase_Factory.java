...
public final class GetCurrentSubscriptionUseCase_Factory implements Factory<GetCurrentSubscriptionUseCase> {
  ...
  public GetCurrentSubscriptionUseCase_Factory(
  ...
  public static GetCurrentSubscriptionUseCase_Factory create(
      Provider<BillingRepository> billingRepositoryProvider) {
    return new GetCurrentSubscriptionUseCase_Factory(billingRepositoryProvider);
  }

  public static GetCurrentSubscriptionUseCase newInstance(BillingRepository billingRepository) {
    return new GetCurrentSubscriptionUseCase(billingRepository);
  }
}
